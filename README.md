...
- Настройки (`CPS`, бинды) меняются прямо с локального сайта.
- Если Minecraft не найден, функции авто-клика/строительства автоматически отключаются.
